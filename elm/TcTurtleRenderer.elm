...
type alias State = { position : Position, angle : Float, lines : List (Svg msg), Color : String}
...
changeColor : String -> State -> State
changeColor newcolor state =
    { state | color = newcolor}

changeWidth : String -> State -> State
change Width newwidth state =
